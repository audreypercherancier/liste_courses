...
<div class="col-12">
		...
		<form method="post" action="${pageContext.request.contextPath}/nouvelle" class="row justify-content-center mb-2">
			...
			<div class="row">
				...
				<li class="list-group-item d-flex justify-content-between align-items-center">
					...
					<div>
						<a href="" class="badge text-success" title="Ajouter"><i class="material-icons">add</i></a>
					</div>
				</li>
			</ul>
		</div>
	...
	<footer class="row bg-dark footer-demodule fixed-bottom py-1">
		<div class="col-lg-4 offset-lg-4 text-center">
			<a class="btn" href="${pageContext.request.contextPath}/Listes.jsp" title="Retour Ã  la liste des courses"><i class="material-icons">arrow_back</i></a>
		</div>
